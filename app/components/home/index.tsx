        ...
        <div className="container-fluid" id="hero">
            <div className="container">
                <div className="col-lg-6 mx-auto text-center d-flex flex-column justify-content-center align-items-center" style={{ height: "100vh" }}>
                    <h1 className={`text-xxlarge text-narrow-height ${GoodTimes.className}`} dangerouslySetInnerHTML={{ __html: homeCopy.header.title }}></h1>
                ...
                <div className="col-12 text-center">
                    <h2 className={`text-xlarge text-white ${GoodTimes.className}`} dangerouslySetInnerHTML={{ __html: homeCopy.segment1.title }}></h2>
                </div>
                <div className="row mt-5 pt-5">
                    <div className="col-lg-3 white-border text-center p-5 bl-half bb-half br-half position-relative overflow-hidden  hover-bb">
                        ...
                        <h5 className={`text-uppercase text-medium text-narrow-height my-3 ${GoodTimes.className}`} dangerouslySetInnerHTML={{ __html: homeCopy.segment1.cards[0].title }}></h5>
                    ...
                    <div className="col-lg-3 white-border text-center p-5 bl-half bb-half br-half position-relative overflow-hidden  hover-bb">
                        ...
                        <h5 className={`text-uppercase text-medium text-narrow-height my-3 ${GoodTimes.className}`} dangerouslySetInnerHTML={{ __html: homeCopy.segment1.cards[1].title }}></h5>
                        <p className="text-thin text-n300 text-small text-narrow-height mt-4">
                    ...
                    <div className="col-lg-3 white-border text-center p-5 bl-half bb-half br-half position-relative overflow-hidden  hover-bb">
                        ...
                        <h5 className={`text-uppercase text-medium text-narrow-height my-3 ${GoodTimes.className}`} dangerouslySetInnerHTML={{ __html: homeCopy.segment1.cards[2].title }}></h5>
                        <p className="text-thin text-n300 text-small text-narrow-height mt-4">
                    ...
                    <div className="col-lg-3 white-border text-center p-5 bl-half bb-half br-half position-relative overflow-hidden  hover-bb">
                        ...
                        <h5 className={`text-uppercase text-medium text-narrow-height my-3 ${GoodTimes.className}`} dangerouslySetInnerHTML={{ __html: homeCopy.segment1.cards[3].title }}></h5>
                        <p className="text-thin text-n300 text-small text-narrow-height mt-4">
                ...
                <div className="row my-5">
                    <div className="col-12 white-border d-flex justify-content-center align-items-center text-center p-5 bl-half bb-half br-half position-relative overflow-hidden  hover-b" id="bg-gradient-dots">
                        <p className={`text-medium-mob ${GoodTimes.className}`} dangerouslySetInnerHTML={{ __html: homeCopy.segment2.content }}></p>
                    </div>
                </div>
            </div>
        </div>
